...
int main() {
	...
	spheres.push_back(Sphere(Vec3f(6.0, -2, -17.5), 2, Vec3f(0.90, 0.76, 0.46), 0, 0.0));
	spheres.push_back(Sphere(Vec3f(5.5, 0, -25), 3, Vec3f(0.65, 0.77, 0.97), 0, 0.0));
	spheres.push_back(Sphere(Vec3f(-5.75, 0, -17), 3, Vec3f(0.90, 0.90, 0.90), 0, 0.0));
	// light
//	spheres.push_back(Sphere(Vec3f(0.0, -20, -37.5), 3, Vec3f(0.00, 0.00, 0.00), 0, 0.0, Vec3f(3)));
